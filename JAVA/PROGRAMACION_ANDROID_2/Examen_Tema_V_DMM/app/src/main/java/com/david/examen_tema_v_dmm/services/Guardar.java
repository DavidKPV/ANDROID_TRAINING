...
public class Guardar {
    ...
    public Guardar(String titulo, String asunto, String fecha, String descripcion, String nota, Context contexto, Activity activity) {
        this.titulo = titulo;
        this.asunto = asunto;
        this.fecha = fecha;
    ...
    public void insertar() {
        ...
        StringRequest respuesta = new StringRequest(
            ...
            protected Map<String, String> getParams() {
                ...
                parametros.put("opcion", "insertar");
                return parametros;
            }
