...
public class MainActivity extends AppCompatActivity {
    ...
    private void guardarDatos(){
        // OBTENEMOS LOS DATOS DE LOS EDIT TEXT
        ...
        if(!nombre.isEmpty() && !direccion.isEmpty() && !telefono.isEmpty()){
            ...
            usuario.Nuevo(nombre, telefono, direccion);
            ...
            Toast.makeText(getApplicationContext(),"ES OBLIGATORIO RELLENAR TODOS LOS CAMPOS", Toast.LENGTH_LONG).show();
        }
    }
